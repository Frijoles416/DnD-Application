...
if place_meeting(x, y, obj_player)
{
	switch(image_index)
	{
		case 0:
		{
		info = "Sequestered in high mountains atop tall trees, \nthe aarakocra, sometimes called birdfolk, \nevoke fear and wonder. \n \nRacial Traits : +2 Dexterity, +1 Wisdom, Flight, Talons"
		break;
		}
		
		case 1:
		{
		info = "Aasimar are placed in the world to serve as guardians of \nlaw and good. Their patrons expect them to strike at evil, \nlead by example, and further the cause of justice. \nRacial Traits : +2 Charisma, Darkvision, \nCelestial Resistance, Healing Hands, Light Bearer"
		break;
		}
		
		case 2:
		{
		info = "Bugbears feature in the nightmare tales of many races — \ngreat, hairy beasts that creep through the shadows \nas quiet as cats.\nRacial Traits : +2 Strength, +1 Dexterity, Darkvision,\nLong-Limbed, Powerful Build, Sneaky, Surprise Attack"
		break;
		}
		
		case 3:
		{
		info = "Roamers at heart, centaurs love open \nspaces and the freedom to travel.\nRacial Traits : +2 Strength, +1 Wisdom, Charge, Hooves, \nEquine Build, Survivor, Hybrid Nature"
		break;
		}
		
		case 4:
		{
		info = "A changeling can shift its face and form with a thought \nas a form of artistic and emotional expression.\nRacial Traits : +2 Charisma, +1 Dexterity or Intelligence, \nChange Appearance, Changeling Instincts, \nUnsettling Visage, Divergent Persona"
		break;
		}
		
		case 5:
		{
		info = "Dragonborn look very much like dragons standing erect \nin humanoid form, though they lack wings or a tail.\nRacial Traits : +2 Strength, +1 Charisma, \nDraconic Ancestry, Breath Weapon, Damage Resistance"
		break;
		}
		...
		case 34:
		{
		info = "Viashino are humanoid reptiles fueled \nby an inner fire of zeal.\nRacial Traits : +2 Dexterity, +1 Strength, Bite, \nLashing Tail, Wiry Frame"
		break;
		}
