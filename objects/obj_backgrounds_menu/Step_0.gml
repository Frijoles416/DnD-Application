...
if mouse_check_button_released(mb_left) && place_meeting(x, y, obj_player) && !place_meeting(x, y, obj_language_selection)
{
	switch(image_index)
	{
		...
		case 13:
		{
			...
			ds_list_add(obj_player.BackgroundInventoryList, "Unusual weapon of your choice", "Favor of an admirer (love letter, lock of hair, or trinket)", "Costume")
		...
		case 14:
		{
			...
			ds_list_add(obj_player.BackgroundInventoryList, "Artisan's tools of your choice", "Letter of introduction from guild", "Traveler's clothes")
			CanChooseArtisansTools = true
		...
		case 33:
		{
			...
			ds_list_add(obj_player.BackgroundInventoryList, "Uniform of your company", "Insignia of your rank", "Gaming set of your choice")
			ds_list_add(obj_player.ToolsList, "Gaming Set", "Land Vehicles")
		...
		case 39:
		{
			...
			ds_list_add(obj_player.BackgroundInventoryList, "Insignia of rank", "Trophy from a fallen enemy", "Gaming set of your choice", "Common clothes")
			ds_list_add(obj_player.ToolsList, "Gaming Set", "Land Vehicles")
			CanChooseGamingSet = true
